...
const ManageInventory = ({ inventory, setInventorys }) => {
    ...
    if (confirmDelete) {
      ...
      await axios
        ...
        .then(response => {
          ...
          const filterDelete = inventory.filter(product => product._id !== id)
    ...
    <tr className="">
      ...
      <td className="">
        <h6 className="mange-details">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#42baf4" class="bi bi-plus-circle-fill me-3" viewBox="0 0 16 16">
      ...
      <td className="svg-div">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="rgb(255, 121, 121)" onClick={() => handleDelete(_id)}  class="bi bi-trash2-fill me-5 svg-icon" viewBox="0 0 16 16">
          <path d="M2.037 3.225A.703.703 0 0 1 2 3c0-1.105 2.686-2 6-2s6 .895 6 2a.702.702 0 0 1-.037.225l-1.684 10.104A2 2 0 0 1 10.305 15H5.694a2 2 0 0 1-1.973-1.671L2.037 3.225zm9.89-.69C10.966 2.214 9.578 2 8 2c-1.58 0-2.968.215-3.926.534-.477.16-.795.327-.975.466.18.14.498.307.975.466C5.032 3.786 6.42 4 8 4s2.967-.215 3.926-.534c.477-.16.795-.327.975-.466-.18-.14-.498-.307-.975-.466z" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#42baf4" onClick={() => navigate("/addInventory")} class="bi bi-plus-square-fill  svg-icon" viewBox="0 0 16 16">
